...
/** 精简内联图标集（lucide 风格：24 viewBox、stroke currentColor、圆角端点） */
const PATHS: Record<string, JSX.Element> = {
  ...
  paperclip: (
    <path d="M16 6l-4.19-4.19a2.13 2.13 0 0 0-3.01 0L3.6 6.99a6 6 0 0 0 8.49 8.49l7.51-7.5a4 4 0 1 0-5.66-5.66l-7.51 7.51a2 2 0 1 0 2.83 2.83L15.5 6.5" />
  ),
